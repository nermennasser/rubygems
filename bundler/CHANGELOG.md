...
Improvements:
  ...
  - `bundle gem` now ships with a default `.rubocop.yml` file which reduces the number of offenses on the gem skeleton generated by default [#3731](https://github.com/rubygems/rubygems/pull/3731)
